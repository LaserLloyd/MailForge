; Inno Setup script — BlueBox Windows installer (build spec §10).
;
; Flow:
;   1. PyInstaller folder-mode build produces dist\bluebox\ (see
;      packaging/pyinstaller.spec — NEVER onefile).
;   2. This script packages that folder into a single Setup.exe.
;   3. On install it lays the folder under {autopf}\BlueBox and
...
#define MyAppName "BlueBox"
#define MyAppVersion "0.1.0"
#define MyAppPublisher "OpenClaw"
#define MyAppExeName "bluebox.exe"
#define ServiceId "bluebox"
...
OutputBaseFilename=bluebox-setup
...
Source: "..\..\dist\bluebox\*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs
