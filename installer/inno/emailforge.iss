; Inno Setup script — EmailForge Windows installer (build spec §10).
;
; Flow:
;   1. PyInstaller folder-mode build produces dist\emailforge\ (see
;      packaging/pyinstaller.spec — NEVER onefile).
;   2. This script packages that folder into a single Setup.exe.
;   3. On install it lays the folder under {autopf}\EmailForge and
...
#define MyAppName "EmailForge"
#define MyAppVersion "0.1.0"
#define MyAppPublisher "OpenClaw"
#define MyAppExeName "emailforge.exe"
#define ServiceId "emailforge"
...
OutputBaseFilename=emailforge-setup
...
Source: "..\..\dist\emailforge\*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs
