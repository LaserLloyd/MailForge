; Inno Setup script — SiftForge Windows installer (build spec §10).
;
; Flow:
;   1. PyInstaller folder-mode build produces dist\siftforge\ (see
;      packaging/pyinstaller.spec — NEVER onefile).
;   2. This script packages that folder into a single Setup.exe.
;   3. On install it lays the folder under {autopf}\SiftForge and
...
#define MyAppName "SiftForge"
#define MyAppVersion "0.1.0"
#define MyAppPublisher "SiftForge"
#define MyAppExeName "siftforge.exe"
#define ServiceId "siftforge"

[Setup]
AppId={{B7E1F0A2-0C3D-4E5F-9A8B-SIFTFORGEAPP}}
AppName={#MyAppName}
...
OutputBaseFilename=siftforge-setup
...
Source: "..\..\dist\siftforge\*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs
