...
``bluebox demo`` builds a temporary application home (config + data +
...
The seeding is a plain function of a :class:`~bluebox.db.store.Store`
...
DEMO_CONFIG_TOML = """# bluebox demo configuration (throwaway).
