...
Wraps ``uv tool run emailforge serve`` with **WinSW-x64.exe** (MIT) — NOT
...
_XML_TEMPLATE = """<service>
  ...
  <arguments>tool run emailforge serve</arguments>
