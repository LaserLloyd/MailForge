...
``mailforge demo`` builds a temporary application home (config + data +
...
The seeding is a plain function of a :class:`~mailforge.db.store.Store`
...
DEMO_CONFIG_TOML = """# mailforge demo configuration (throwaway).
