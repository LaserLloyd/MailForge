...
Wraps ``uv tool run mailforge serve`` with **WinSW-x64.exe** (MIT) — NOT
...
SERVICE_ID = "mailforge"
EXE_NAME = "WinSW-x64.exe"
XML_NAME = "mailforge.xml"

# WinSW descriptor. WinSW derives the .xml path from the renamed exe, but we
# keep an explicit, conventional pair (mailforge.exe + mailforge.xml)
...
_XML_TEMPLATE = """<service>
  ...
  <arguments>tool run mailforge serve</arguments>
