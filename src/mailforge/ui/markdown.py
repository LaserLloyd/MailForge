...
def reader(
    ...
    *,
    ...
    with ui.card().classes("w-full bb-card bb-reader-card").style("padding: 16px"):
        with ui.row().classes("w-full items-center").style("gap: 8px"):
            ...
            with ui.dialog().props("maximized transition-show=slide-up") as dialog:
                with ui.card().classes("bb-reader-window"):
                    with ui.row().classes(
                        "w-full items-center q-pa-md bb-reader-window-header"
                    ):
                    ...
                    with ui.element("div").classes(
                        "w-full bb-reader-window-content q-pa-lg"
                    ):
                        _content()
