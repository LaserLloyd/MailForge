...
``openclaw-email demo`` builds a temporary application home (config + data +
...
The seeding is a plain function of a :class:`~openclaw_email.db.store.Store`
...
DEMO_CONFIG_TOML = """# openclaw-email demo configuration (throwaway).
