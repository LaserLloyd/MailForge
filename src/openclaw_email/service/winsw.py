...
Wraps ``uv tool run openclaw-email serve`` with **WinSW-x64.exe** (MIT) — NOT
...
_XML_TEMPLATE = """<service>
  ...
  <arguments>tool run openclaw-email serve</arguments>
