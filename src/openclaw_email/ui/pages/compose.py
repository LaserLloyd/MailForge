...
def render(
    ...
    with ui.card().classes("w-full oce-card").style(
        ...
        with ui.row().classes("w-full items-center oce-toolbar"):
            ...
            ).props("outlined dense clearable").classes("col oce-toolbar-grow")
        ...
        with ui.row().classes("w-full justify-end oce-toolbar").style("gap: 8px"):
    ...
    def _sent_history() -> None:
        ...
        ).classes("w-full oce-card").style("max-width: 820px"):
            if not rows:
