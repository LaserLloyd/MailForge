...
by calling :func:`openclaw_email.ui.app.refresh_inbox` (NiceGUI WS). Clicking
...
def _stat_chip(label: str, n: int, color: str = "var(--text-primary)") -> None:
    with ui.element("div").classes("oce-stat"):
        ui.label(str(n)).classes("oce-stat-n").style(f"color: {color}")
