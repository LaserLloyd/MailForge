...
``siftforge demo`` builds a temporary application home (config + data +
...
The seeding is a plain function of a :class:`~siftforge.db.store.Store`
...
DEMO_CONFIG_TOML = """# siftforge demo configuration (throwaway).
