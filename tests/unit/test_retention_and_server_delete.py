...
from emailforge.config import IMAPAccount, SecuritySettings, Settings
from emailforge.db.store import Store, open_store
from emailforge.mail import retention
from emailforge.mail.server_delete import DeleteOutcome
...
def test_trash_folder_is_found_by_well_known_name():
    from emailforge.mail.server_delete import find_trash_folder
...
def test_delete_uids_is_a_no_op_when_mode_is_off():
    from emailforge.config import IMAPAccount
    from emailforge.mail.server_delete import delete_uids
